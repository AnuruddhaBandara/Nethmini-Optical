...
@section('content')
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="text-uppercase mb-0"><span class="text-muted">Supplier</span> <span class="mx-2">/</span> All
                Supplier</h5>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table id="supplier_list" class="table table-striped" style="width:100%">
                <thead>
                <tr>
                    @role('admin')
                    <th>Branch</th>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#supplier_list').DataTable(dataTableOptions);
        });
